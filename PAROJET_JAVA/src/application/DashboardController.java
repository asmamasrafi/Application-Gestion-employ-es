...
public class DashboardController implements Initializable {
    ...
    @FXML
    private TextField salary_firstName;
    ...
    @FXML
    private Button emplye;

    @FXML
    private TextField salary_position;
	 ...
	 @FXML
	   void addEmployeeGendernList() {
	    ...
	    void addEmployeeReset() {
	        ...
	        addEmployee_image.setImage(image);
	        String defaultImagePath = "..\\..\\..\\..\\Downloads\\6088104.png";
	        getData.path = defaultImagePath;

	        // Load and set the image
	        Image defaultImage = new Image("file:" + defaultImagePath, 101, 127, false, true);
	        addEmployee_image.setImage(defaultImage);
	    }
	    
	   

	    @FXML
	    void addEmployeeUpdate() {
	    	 String uri = getData.path;
	         uri = uri.replace("\\", "\\\\");
 ...
 try {
    ...
    void switchForm(ActionEvent event) {
            ...
            if (event.getSource() == home_btn) {
            	System.out.println("Switching to home form...");
                home_form.setVisible(true);
                addEmployee_form.setVisible(false);
                salary_form.setVisible(false);

                home_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #3a4368, #BBDAFF);");
                emplye.setStyle("-fx-background-color:transparent");
            ...
            } else if (event.getSource() == emplye) {
            	 System.out.println("Switching to addEmployee form...");
                home_form.setVisible(false);
                addEmployee_form.setVisible(true);
                salary_form.setVisible(false);

                emplye.setStyle("-fx-background-color:linear-gradient(to bottom right, #3a4368, #BBDAFF);");
            	...
            	System.out.println("Switching to salary form..."); 
            	 salary_form.setVisible(true);
                home_form.setVisible(false);
                addEmployee_form.setVisible(false);
              

                salary_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #3a4368, #BBDAFF);");
                emplye.setStyle("-fx-background-color:transparent");
                home_btn.setStyle("-fx-background-color:transparent");
